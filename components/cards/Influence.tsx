import { influenceList } from '@/constants/projects'
          ...
          <div key={project.id} className="bg-[#070707] p-3 text-white rounded-[12px] text-left">
            ...
            <div className='p-1 pt-3'>
              <div className='flex justify-between'>
                <Link href={project.link} target="_blank" className="text-[#585858] transition-colors duration-200 hover:text-white/80">— {project.project} <span className='max-2xl:hidden'>| {project.role}</span></Link>
